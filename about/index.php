            ...
            <div class="row  align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="about-progress-inner">
                        ...
                        <!-- inner start -->
                        <div class="inner">
                            <p class="disc">Ονομάζομαι <b> Μελισσουργός Κωνσταντίνος </b>, είμαι γεννημένος στην Αθήνα
                                και από νωρίς είχα πάθος για τη γνώση, τη δημιουργία και την καινοτομία.
                                Εκπαίδευση που ενώνει τα πεδία της Χρηματοοικονομικής και του Προγραμματισμού.</p>



                            <p class="disc">Επενδύω συνεχώς στην ανάπτυξη του εαυτού του,έχοντας παραστεί σε πλήθος
                                εκπαιδευτικών σεμιναρίων για το Management σε Ελλάδα και Αμερική.
                                Η εργασιακή μου πορεία μιλά από μόνη της για τον επαγγελματισμό και τη
                                δέσμευσή μου. Έχοντας συνεργαστεί με κορυφαία ονόματα στο χώρο, όπως η Alpha Bank και η
                                NN Hellas, έχω αποκτήσει πολύτιμη εμπειρία και γνώσεις που με καθιστούν αξιόπιστο και  ειδικό
                                στον ασφαλιστικό τομέα. </p>
